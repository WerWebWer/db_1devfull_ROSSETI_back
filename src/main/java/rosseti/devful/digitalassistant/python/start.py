...
in_file = "c:/Users/Werwe/Desktop/db_1devfull_ROSSTI_back/src/main/java/rosseti/devful/digitalassistant/python/data.txt"
out_file = "c:/Users/Werwe/Desktop/db_1devfull_ROSSTI_back/src/main/java/rosseti/devful/digitalassistant/python/out.txt"
docs = []
...
def Word_Distance_Document(res1,wx,res2,wy,res3,res4,Vt,p,c,Z,U):
    ...
    for i in range(0,len(aa)):
        ...
        print(tr)
        count = 0
        if aa[i][0] == ddd-1 or aa[i][1] == ddd-1:
            count = count + 1
            f.write('%s %s %s\n'%(aa[i][0],aa[i][1],bb[i]))
    f.close()
